...
F 1 "10n" H 5765 1005 50  0000 L CNN
...
F 1 "1u" H 6165 1005 50  0000 L CNN
...
F 1 "1u" H 5365 1005 50  0000 L CNN
F 2 "Capacitor_SMD:C_1206_3216Metric" H 5288 900 50  0001 C CNN
...
F 1 "100n" H 1715 3405 50  0000 L CNN
...
F 1 "1u" V 5450 2550 50  0000 C CNN
...
F 1 "1u" V 5350 2050 50  0000 L CNN
...
F 1 "100n" H 12000 950 50  0000 L CNN
...
F 1 "1u" H 8815 2855 50  0000 L CNN
F 2 "Capacitor_SMD:C_1206_3216Metric" H 8738 2750 50  0001 C CNN
...
Wire Wire Line
	5750 8550 5600 8550
Text GLabel 11800 8850 0    50   BiDi ~ 0
uSD_D0
...
U 1 1 5E3EECFA
P 12700 7950
F 0 "R8" V 12650 8100 50  0000 L CNN
F 1 "47k" V 12650 7700 50  0000 L CNN
...
U 1 1 5E94B2B7
P 13000 8750
F 0 "#PWR0342" H 13000 8500 50  0001 C CNN
F 1 "GND" V 13000 8550 50  0000 C CNN
...
U 1 1 5E968D86
P 13000 9150
F 0 "#PWR0343" H 13000 8900 50  0001 C CNN
F 1 "GND" V 13000 8950 50  0000 C CNN
...
U 1 1 5E986791
P 14800 9300
F 0 "#PWR0344" H 14800 9050 50  0001 C CNN
...
USART1_TX_CTRL
Text GLabel 8900 8400 0    50   Output ~ 0
USART1_RX_CTRL
Wire Wire Line
	9350 8300 8900 8300
Wire Wire Line
...
F 1 "100n" V 10089 8000 50  0000 C CNN
...
F 0 "#PWR0349" H 9750 7600 50  0001 C CNN
F 1 "+3.3V" H 9765 7923 50  0000 C CNN
...
F 1 "W25Q128JVSIQ" H 11941 1705 50  0000 L CNN
...
F 1 "100n" H 13000 1100 50  0000 L CNN
...
F 1 "1u" H 9715 1855 50  0000 L CNN
F 2 "Capacitor_SMD:C_1206_3216Metric" H 9638 1750 50  0001 C CNN
...
U 1 1 61C8D11D
P 9750 8400
F 0 "U6" H 9350 8800 50  0000 C CNN
F 1 "SN65HVD234" H 9450 8700 50  0000 C CNN
F 2 "Package_SO:SOIC-8_3.9x4.9mm_P1.27mm" H 9750 7900 50  0001 C CNN
F 3 "http://www.ti.com/lit/ds/symlink/sn65hvd234.pdf" H 9650 8800 50  0001 C CNN
	1    9750 8400
	1    0    0    -1  
$EndComp
Wire Wire Line
...
$EndComp
$Comp
L Womo-rescue:R-Device R9
U 1 1 61E887E3
P 9100 9000
F 0 "R9" H 8750 9050 50  0000 L CNN
F 1 "47k" H 8750 8950 50  0000 L CNN
...
Wire Wire Line
	9100 8600 9100 8850
$Comp
L Womo-rescue:R-Device R10
U 1 1 65E207EA
P 950 4150
F 0 "R10" H 1020 4196 50  0000 L CNN
F 1 "120R" H 1020 4105 50  0000 L CNN
...
$EndComp
$Comp
L Womo-rescue:+3.3V-power #PWR0280
U 1 1 65E4E132
P 950 4000
F 0 "#PWR0280" H 950 3850 50  0001 C CNN
...
Wire Wire Line
	950  4750 950  4600
Text GLabel 3050 7950 0    50   Output ~ 0
BLE_RST
$Comp
L Womo-rescue:LED-Device D2
U 1 1 66496B0D
P 950 6000
F 0 "D2" V 988 5883 50  0000 R CNN
F 1 "LED" V 897 5883 50  0000 R CNN
F 2 "LED_SMD:LED_1206_3216Metric" H 950 6000 50  0001 C CNN
F 3 "~" H 950 6000 50  0001 C CNN
	1    950  6000
	0    -1   -1   0   
$EndComp
$Comp
L Womo-rescue:R-Device R11
U 1 1 66496B13
P 950 5700
F 0 "R11" H 1020 5746 50  0000 L CNN
F 1 "120R" H 1020 5655 50  0000 L CNN
...
$EndComp
$Comp
L Womo-rescue:+3.3V-power #PWR0338
U 1 1 66496B19
P 950 5250
F 0 "#PWR0338" H 950 5100 50  0001 C CNN
F 1 "+3.3V" H 965 5423 50  0000 C CNN
...
$EndComp
$Comp
L Womo-rescue:GND-power #PWR0351
U 1 1 664C4A78
P 950 6150
F 0 "#PWR0351" H 950 5900 50  0001 C CNN
...
U 1 1 664F57F0
P 950 5400
F 0 "JP1" V 904 5468 50  0000 L CNN
F 1 "SolderJumper_2_Open" V 995 5468 50  0000 L CNN
F 2 "Jumper:SolderJumper-2_P1.3mm_Open_RoundedPad1.0x1.5mm" H 950 5400 50  0001 C CNN
F 3 "~" H 950 5400 50  0001 C CNN
	1    950  5400
	0    1    1    0   
$EndComp
$Comp
L Womo-Lin:Connector_Micro_SD_Card_Det_Hirose_DM3AT J5
U 1 1 6D37A5C2
P 13900 8650
F 0 "J5" H 13850 9467 50  0000 C CNN
F 1 "Connector_Micro_SD_Card_Det_Hirose_DM3AT" H 13850 9376 50  0000 C CNN
F 2 "Womo-Lin:mico_sd" H 15950 9350 50  0001 C CNN
F 3 "https://www.hirose.com/product/en/download_file/key_name/DM3/category/Catalog/doc_file_id/49662/?file_category_id=4&item_id=195&is_series=1" H 13900 8750 50  0001 C CNN
	1    13900 8650
	1    0    0    -1  
$EndComp
Wire Wire Line
	13000 8650 11800 8650
Wire Wire Line
	11950 8100 11950 8950
Wire Wire Line
	11950 8950 13000 8950
Connection ~ 11950 8950
Wire Wire Line
	11800 8850 12100 8850
Wire Wire Line
	12100 8100 12100 8850
Connection ~ 12100 8850
Wire Wire Line
	12100 8850 13000 8850
Wire Wire Line
	12700 8100 12700 9050
Wire Wire Line
	12700 9050 13000 9050
Wire Wire Line
	13000 8550 12800 8550
Wire Wire Line
	12800 8550 12800 7600
...
U 1 1 5E442A81
P 12700 7300
F 0 "#PWR0367" H 12700 7150 50  0001 C CNN
...
Wire Wire Line
	12700 7800 12700 7300
Wire Wire Line
	14700 9150 14800 9150
Wire Wire Line
	14800 9150 14800 9300
$EndSCHEMATC
