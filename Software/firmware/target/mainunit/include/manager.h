...
namespace womolin::target
{
   ...
   {
      public:
         Manager( Driver & attDriver, Serial & attSerial );
         ~Manager() = default;
      ...
      private:
         ...
         HalOutput                 HAL_SIMULATION          { HalOutput( DEV_ID::SIMULATION , driver ) };
         HalInput                  HAL_SIMULATION_STAT     { HalInput( DEV_ID::SIMULATION ) }; 
         HalInput                  HAL_FWVER               { HalInput( DEV_ID::FWVER ) }; 

         // board hal units
         HalOutput                 HAL_K1                  { HalOutput( DEV_ID::K1 , driver ) };
         HalOutput                 HAL_K2                  { HalOutput( DEV_ID::K2 , driver ) };
         HalOutput                 HAL_K3                  { HalOutput( DEV_ID::K3 , driver ) };
         HalOutput                 HAL_K4                  { HalOutput( DEV_ID::K4 , driver ) };
         ...
         HalInput                  HAL_ADC1                { HalInput( DEV_ID::MAINUNIT_ADC1 ) };
